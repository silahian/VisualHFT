...
{
    public partial class STRATEGY_PARAMETERS_FIRMMM
    {
        public void CopyTo(StrategyParametersFirmMMVM item)
        {
    ...
    public class StrategyParametersFirmMMVM : STRATEGY_PARAMETERS_FIRMMM, INotifyPropertyChanged, IStrategyParameters
	{
        ...
        public StrategyParametersFirmMMVM()
        { }
        public StrategyParametersFirmMMVM(STRATEGY_PARAMETERS_FIRMMM item)
        {
        ...
        public STRATEGY_PARAMETERS_FIRMMM ThisToDBObject()
        {
            var item = new STRATEGY_PARAMETERS_FIRMMM();
        ...
        public new bool PipsHedgeTrailing
        {
            get { 
				return base.PipsHedgeTrailing;
			}
            set
            {

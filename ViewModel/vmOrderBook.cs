...
namespace VisualHFT.ViewModel
{
    public class vmOrderBook : BindableBase, IDisposable
    {
        ...
        public CachedCollection<BookItem> _bidsGrid;
        public CachedCollection<BookItem> _asksGrid;
        ...
        private void uiUpdaterAction()
        {
            ...
            if (_MARKETDATA_AVAILABLE)
            {
                ...
                RaisePropertyChanged(nameof(DepthAsks));
                RaisePropertyChanged(nameof(DepthBids));
        ...
        public IEnumerable<BookItem> DepthAsks { get { return Asks; } }
        public IEnumerable<BookItem> DepthBids { get { return Bids; } }

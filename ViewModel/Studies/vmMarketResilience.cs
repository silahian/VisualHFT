...
{
    public class vmMarketResilience : BindableBase, IDisposable
    {
        ...
        private void Clear()
        {
            ...
            if (_Study != null)
                _Study.Dispose();
            _Study = null;
            _Study = new MarketResilienceStudy(_selectedSymbol, _selectedProvider.ProviderCode, _aggregationLevelSelection, _MAX_ITEMS);

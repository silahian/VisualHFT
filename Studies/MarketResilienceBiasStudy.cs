...
{
    public class MarketResilienceBiasStudy : IDisposable
    {
        ...
        public MarketResilienceBiasStudy(string symbol, int providerId, AggregationLevel aggregationLevel, int rollingWindowSize = 50, int levelsToConsume = 3, double spread_increase = 1.0)
        {

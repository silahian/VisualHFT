...
namespace MarketConnectors.KuCoin
{
    public class KuCoinPlugin : BasePluginDataRetriever
    {
        ...
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(KuCoinPlugin));
        ...
        {
            return new VisualHFT.Model.Provider() { ProviderID = 4, ProviderName = "KuCoin" };
        }
    }
}

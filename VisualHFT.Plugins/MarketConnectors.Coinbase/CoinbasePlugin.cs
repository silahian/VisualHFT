...
namespace MarketConnectors.Gemini
{
    public class CoinbasePlugin : BasePluginDataRetriever
    {
        ...
        private static readonly log4net.ILog log = log4net.LogManager.GetLogger(typeof(CoinbasePlugin));
        ...
        {
            return new VisualHFT.Model.Provider() { ProviderID = 8, ProviderName = "Coinbase" };
        }
    }
}
